...
def load_models():
    ...
    # Use OpenAI for chat, local model for embeddings
    llm = ChatOpenAI(model="gpt-3.5-turbo", temperature=0, api_key=api_key)
    embeddings = SentenceTransformer('all-MiniLM-L6-v2')  # Free local model
...
{parser.get_format_instructions()}"""
        ...
        # Only use OpenAI for final answer generation
        chain = llm | parser
...
st.markdown("---")
st.markdown("**✅ Features:** RAG • Local Embeddings • OpenAI Chat • Source Attribution")